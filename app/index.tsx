...
const Welcome = () => {
  ...
  return (
    <SafeAreaView className="flex-1 items-center justify-center">
      <View className="flex flex-col items-center justify-center w-screen h-screen p-2">
        <Image
        ...
        <View className="flex flex-row gap-2 w-full">
          <Button className="flex-1" onPress={() => router.push("/sign-in")}>
            <Text>Sign in</Text>
          </Button>
          <Button className="flex-1" onPress={() => router.push("/sign-up")}>
            <Text>Sign up</Text>
          </Button>
        </View>
      </View>
