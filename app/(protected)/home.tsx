...
const updateDecision = async (decisionValue: boolean) => {
  try {
    ...
    if (decisionValue) {
      const donorCloseTime = getClosestDonorClosingTime(donorDetails.details.operatingHours);
      const recipientNextOpen = getNextRecipientOpenTime(recipientDetails.details.operatingHours, donorCloseTime);
